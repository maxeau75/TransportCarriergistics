...
public class ShipmentConsigneeGeoLoc {
	...
	public ShipmentConsigneeGeoLoc() {
		super();
		
	}
	public ShipmentConsigneeGeoLoc(String longDirection, String longDegrees, String latDirection, String latDegrees) {
		super();
