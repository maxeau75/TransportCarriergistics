...
public class ShipmentInsuranceGeoloc {
	...
	public ShipmentInsuranceGeoloc() {
		super();
		
	}
	public ShipmentInsuranceGeoloc(String longDirection, String longDegrees, String latDirection, String latDegrees) {
		super();
